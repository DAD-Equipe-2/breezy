    ...
    <div className="flex post bg-foreground-500 text-primary p-4 rounded-lg border border-foreground shadow-md mb-2">
      ...
      <div className="flex flex-col ml-1 pr-2 space-y-2 min-w-0 ml-4">
        ...
        <div className="flex space-x-16">
          <Link href={`/post/${idPost}`} className="cursor-pointer">
          ...
          <div className="flex space-x-1 justify-center items-center">
            <button onClick={toggleLike} className="cursor-pointer">
              ...
              <svg
                className="text-foreground"
                stroke={postInfo.liked ? "red" : "currentColor"}
                strokeWidth={2}
                width="1.5rem"
                height="1.5rem"
                viewBox="0 0 24 24"
                fill={postInfo.liked ? "red" : "none"}
                xmlns="http://www.w3.org/2000/svg"
              >

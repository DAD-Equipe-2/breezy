    ...
    <div className="flex post bg-foreground text-primary">
        ...
        <div className="flex flex-col ml-1 pr-2 space-y-2">
            <div className="flex whitespace-nowrap space-x-2">
                <h2 className="text-background text-bold">Nom d'utilisateur</h2>
                <h3 className="text-grey">@Pseudo</h3>
                <p>Date</p>
            </div>
            <div>
                <p className="text-sm">
            ...
            <div className="flex space-x-16">
                <div className="flex space-x-2">
                    <button>
                        <svg width="1.7rem" height="1.7rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex space-x-2">
                    <button>
                        <svg width="1.5rem" height="1.5rem" viewBox="0 -3.71 75.17 75.17" xmlns="http://www.w3.org/2000/svg">
                            <path id="Path_1" data-name="Path 1" d="M117.606,280.375s22.263-15.459,31.959-30.318c9.6-14.708.354-31.054-10.533-33.8-14.457-3.65-21.426,10.478-21.426,10.478s-6.968-14.128-21.425-10.478c-10.888,2.748-20.132,19.094-10.534,33.8C95.343,264.916,117.606,280.375,117.606,280.375Z" transform="translate(-80.021 -214.131)" fill="none" stroke="#0c2c67" strokeLinejoin="round" strokeWidth="4"/>
                        </svg>
                    </button>
                    <p>3</p>
                </div>

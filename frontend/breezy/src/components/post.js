    ...
    <div className="flex post bg-foreground text-primary">
        ...
        <div className="flex flex-col ml-1 pr-2 space-y-2">
            <div className="flex whitespace-nowrap space-x-2">
                <h2 className="text-background text-bold text-sm font-roboto">Nom d'utilisateur</h2>
                <h3 className="text-secondary text-regular text-sm font-roboto">@Pseudo</h3>
                <p className="text-secondary text-regular text-sm font-roboto">Date</p>
            </div>
            <div>
                <p className="text-secondary text-regular text-sm font-roboto">
